                        ...
                        <tr class="border-b hover:bg-gray-50 transition-all">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-2">
                                    <a href="{{ route('cashier.transaction.edit', $transaction->id) }}"
                                        class="text-[#1779FC] hover:underline">Edit</a>
                                    </a>
                                    <p class="font-bold text-gray-300">|</p>
                                    <a href="{{ route('cashier.transaction.receipt', $transaction->id) }}"
                                        class="text-gray-700 hover:underline">Struk Pembelian</a>
                                    </a>
                                </div>
                            </td>
                        </tr>
