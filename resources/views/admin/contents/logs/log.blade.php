...
@section('title', 'Papery | Log Aktivitas')
@section('content')
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg w-full mt-14">
        ...
        <div class="flex gap-4 justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-600">Log Aktivitas</h1>
                <p class="text-gray-400">Menampilkan daftar riwayat aktivitas pengguna di sistem.</p>
            </div>
        </div>
