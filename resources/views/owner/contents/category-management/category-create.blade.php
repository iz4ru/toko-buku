...
@section('title', 'Papery | Tambah Kategori')
@section('content')
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg w-full mt-14">
        ...
        <div class="flex gap-4 my-4 justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-600">Tambahkan Kategori</h1>
                <p class="text-gray-400">Tambah kategori baru agar data lebih terorganisir dan mudah dikelola.</p>
            </div>
        </div>
        ...
        <section>
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                <h2 class="mb-4 text-xl font-bold text-gray-900">Tambahkan Kategori dan Jenis Buku</h2>
                    ...
                    <div id="bookTypeContainer" class="mb-4 space-y-3">
                        ...
                        @foreach ($oldBookTypes as $index => $type)
                            <div
                                ...
                                <button type="button"
                                    class="removeBtn cursor-pointer text-gray-400 font-bold hover:text-red-500 transition-all hidden">✕</button>
                            </div>
                        @endforeach
                    </div>
