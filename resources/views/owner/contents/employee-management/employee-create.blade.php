...
@section('title', 'Papery | Tambah User')
@section('content')
    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg w-full mt-14">
        ...
        <div class="flex gap-4 my-4 justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-600">Tambah User</h1>
                <p class="text-gray-400">Tambahkan data informasi user baru ke dalam daftar.</p>
            </div>
        </div>
        ...
        <section>
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                <h2 class="mb-4 text-xl font-bold text-gray-900">Tambahkan User Baru</h2>

                <form action="{{ route('owner.employee.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
