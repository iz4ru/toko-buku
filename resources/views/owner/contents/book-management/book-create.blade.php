    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg w-full mt-14">
        ...
        <section>
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                ...
                <form action="{{ route('owner.book.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const generateBookCode = async () => {
                    ...
                    try {
                        const response = await fetch(`/owner/book/generate-code/${categoryId}/${typeId}`);
                ...
                categorySelect.addEventListener('change', function() {
                    ...
                    fetch(`/owner/book/get-types/${categoryId}`)
                        .then(res => res.json())
                        .then(data => {
